...
import { Shield, ArrowLeft, Home, Car, Heart, Briefcase, Umbrella, Check } from "lucide-react"
...
export default function PurchasePage() {
    ...
    home: [
      {
        ...
        name: "Basic Home",
        price: "$100/month",
        features: ["Dwelling coverage", "Personal property coverage", "Liability protection"],
      },
      {
        id: "standard",
        name: "Standard Home",
    ...
    life: [
      {
        ...
        name: "Term Life",
        price: "$30/month",
        features: ["Coverage for a specific term", "Death benefit", "No cash value"],
      },
      {
        id: "whole",
        name: "Whole Life",
        price: "$150/month",
        features: ["Lifetime coverage", "Death benefit", "Cash value accumulation", "Fixed premiums"],
      },
      {
        id: "universal",
        name: "Universal Life",
    ...
    umbrella: [
      {
        ...
        name: "Basic Umbrella",
        price: "$25/month",
        features: ["$1 million in additional liability coverage", "Coverage beyond auto and home policies"],
      },
      {
        id: "standard",
  ...
  const currentPlans = plans[selectedType as keyof typeof plans] || plans.health
    ...
    <div className="flex min-h-screen flex-col bg-gradient-to-br from-slate-50 to-blue-50">
        ...
        <div className="container py-8">
          <div className="mx-auto max-w-3xl">
            <div className="mb-8">
              ...
              <p className="text-slate-600">Find the right coverage for your needs</p>
            </div>
            ...
            <div className="mb-8">
              <div className="flex justify-between">
                <div className={`flex flex-col items-center ${step >= 1 ? "text-blue-600" : "text-slate-400"}`}>
                  <div
                    className={`flex h-10 w-10 items-center justify-center rounded-full shadow-md ${step >= 1 ? "bg-gradient-to-r from-blue-600 to-indigo-500 text-white" : "bg-white border border-slate-200"}`}
                  >
                ...
                <div className="flex-1 self-center">
                  <div
                    className={`h-1 w-full rounded-full ${step >= 2 ? "bg-gradient-to-r from-blue-600 to-indigo-500" : "bg-slate-200"}`}
                  ></div>
                </div>
                <div className={`flex flex-col items-center ${step >= 2 ? "text-blue-600" : "text-slate-400"}`}>
                  <div
                    className={`flex h-10 w-10 items-center justify-center rounded-full shadow-md ${step >= 2 ? "bg-gradient-to-r from-blue-600 to-indigo-500 text-white" : "bg-white border border-slate-200"}`}
                  >
                ...
                <div className="flex-1 self-center">
                  <div
                    className={`h-1 w-full rounded-full ${step >= 3 ? "bg-gradient-to-r from-blue-600 to-indigo-500" : "bg-slate-200"}`}
                  ></div>
                </div>
                <div className={`flex flex-col items-center ${step >= 3 ? "text-blue-600" : "text-slate-400"}`}>
                  <div
                    className={`flex h-10 w-10 items-center justify-center rounded-full shadow-md ${step >= 3 ? "bg-gradient-to-r from-blue-600 to-indigo-500 text-white" : "bg-white border border-slate-200"}`}
                  >
                    3
                  </div>
            ...
            {step === 1 && (
              <Card className="border-none shadow-lg bg-white">
                <CardHeader>
                  ...
                  <CardDescription>Choose the type of insurance you want to purchase</CardDescription>
                </CardHeader>
                <CardContent>
                  <RadioGroup value={selectedType} onValueChange={setSelectedType} className="space-y-3">
                    {insuranceTypes.map((type) => (
                      <div
                        key={type.id}
                        className={`flex items-center space-x-2 p-3 rounded-lg border transition-all ${selectedType === type.id ? "border-blue-500 bg-blue-50" : "border-slate-200 hover:border-blue-200 hover:bg-slate-50"}`}
                      >
                        <RadioGroupItem value={type.id} id={type.id} className="text-blue-600" />
                        <Label htmlFor={type.id} className="flex items-center gap-3 cursor-pointer w-full">
                          <div className={`rounded-full ${type.bgColor} p-2 ${type.color}`}>{type.icon}</div>
            ...
            {step === 2 && (
              <Card className="border-none shadow-lg bg-white">
                <CardHeader>
                  ...
                  <CardDescription>Select the coverage that best fits your needs</CardDescription>
                </CardHeader>
                <CardContent>
                  <RadioGroup value={selectedPlan} onValueChange={setSelectedPlan} className="space-y-4">
                    {currentPlans.map((plan) => (
                      <div
                        key={plan.id}
                        className={`rounded-lg border p-4 transition-all ${selectedPlan === plan.id ? "border-blue-500 bg-blue-50 shadow-md" : "border-slate-200 hover:border-blue-200 hover:bg-slate-50"}`}
                      >
                        ...
                        <Label htmlFor={plan.id} className="cursor-pointer">
                          <div className="flex items-center justify-between">
                            <div>
                              ...
                              <p className="text-sm text-blue-600 font-bold">{plan.price}</p>
                            </div>
                            <div
                              className={`flex h-6 w-6 items-center justify-center rounded-full transition-all ${selectedPlan === plan.id ? "bg-gradient-to-r from-blue-600 to-indigo-500 text-white" : "border border-slate-300"}`}
                            >
            ...
            {step === 3 && (
              <Card className="border-none shadow-lg bg-white">
                <CardHeader>
                  ...
                  <CardDescription>Review and confirm your insurance policy details</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="rounded-lg border p-4 bg-gradient-to-br from-blue-50 to-indigo-50">
                    <h3 className="font-medium text-slate-800">Policy Summary</h3>
                    <div className="mt-3 space-y-3 text-sm">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-medium text-slate-800">June 1, 2025</span>
                      </div>
                    </div>
                  </div>

                  <div className="space-y-4">
                    <h3 className="font-medium text-slate-800">Payment Information</h3>
                  ...
                  <div className="space-y-4">
                    <h3 className="font-medium text-slate-800">Billing Address</h3>
                    <div className="grid gap-4 md:grid-cols-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <Select>
                          <SelectTrigger id="state" className="border-slate-300 focus:ring-blue-500">
                      ...
                      <div className="space-y-2">
                        ...
                        <Select defaultValue="us">
                          <SelectTrigger id="country" className="border-slate-300 focus:ring-blue-500">
      ...
      <footer className="w-full border-t py-4 bg-white mt-auto">
        <div className="container flex flex-col items-center justify-center gap-2 md:flex-row md:justify-between">
          ...
          <p className="text-center text-xs text-slate-500 md:text-left">© 2025 VeriInsure. All rights reserved.</p>
